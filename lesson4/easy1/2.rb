...
=begin
use include Speed at the beginning of each class to add the go_fast method
call the go_fast method on an object of one of the classes to see if it can go fast
=end
